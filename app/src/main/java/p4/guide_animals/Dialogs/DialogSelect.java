...
public class DialogSelect extends AlertDialog {
    ...
    public DialogSelect(Context context, OnSelectedListener onSelectedListener,
                        String Title, String Description, Boolean BtnP, Boolean BtnN, String BtnPName, String BtnNName) {
        super(context);
    ...
    public interface OnSelectedListener {
        public void onSelected(boolean click_btn);
    }

 ...
 */
public class DialogCursorSelect {
    ...
    public DialogCursorSelect(OnSelectedListener onSelectedListener, Context getContext){
        this.onSelectedListener = onSelectedListener;
        context = getContext;
    }

  public AlertDialog getDialog(int id, String title,final String columnname, final Cursor cursor,final boolean[] check)
  {
          ...
          case IDD_LIST:
              ...
              builder.setCursor(cursor, new DialogInterface.OnClickListener() {
                  ...
                  public void onClick(DialogInterface dialog, int item) {
                      ...
                      onSelectedListener.onSelected(item, cursor, null);
...
*/
    ...
    public interface OnSelectedListener {
        ...
        public void onSelected(int id, Cursor cursor, boolean[] mCheckedItems);
